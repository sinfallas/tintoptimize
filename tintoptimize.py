...
# Project information
NAME = "tintoptimize"
AUTHORS = ["Jesus Palencia <sinfallas@gmail.com>"]
VERSION = "0.3.4"
COMMENTS = "optimize tint2"
WEBSITE = "https://github.com/sinfallas/tintoptimize"
...
class TintWizardGUI(gtk.Window):
	...
	def readConf(self):
		...
		if self.oneConfigFile:
			# don't need tintoptimize.conf
			return

		pathName = os.path.expandvars("${HOME}") + "/.config/tint2/"

		if not os.path.exists(pathName + "tintoptimize.conf"):
			self.writeConf()
			return

		f = open(pathName + "tintoptimize.conf", "r")
	...
	def writeConf(self):
		...
		f = open(pathName+"tintoptimize.conf", "w")
